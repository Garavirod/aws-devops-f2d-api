...
/* 
We alse going to be using it for the task role, which determines which permissions the
actual application running in the task will have when it's running in ECS.
*/
